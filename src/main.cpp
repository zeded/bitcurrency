...
#if defined(NDEBUG)
# error "BitCurrency cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BitCurrency Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
     int64_t nSubsidy = 0;
     if(nHeight == 1) {
         nSubsidy = 181600000 * COIN; //181.6 million BTCR premine
         }
         else {
...
{
    RenameThread("bitcurrency-loadblk");
